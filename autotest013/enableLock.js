...
async function puppeteer2() {
    ...
    try {
        ...
        await page.waitFor(3000)
        await page.evaluate(async()=>await document.querySelectorAll('[class="react-toggle-screenreader-only"][aria-label="See other viewers webcams"]')[0].parentElement.click());
        await page.waitFor(3000)
        await page.evaluate(
