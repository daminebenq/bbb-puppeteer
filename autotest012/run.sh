...
timeout $TIMELIMIT_UPPER node puppeteer1.js "$URL" "$basePath" $TIMELIMIT_SECONDS &> $basePath/puppeteer1.out &
pids+=($!)
timeout $TIMELIMIT_UPPER node puppeteer2.js "$URL" "$basePath" $TIMELIMIT_SECONDS &> $basePath/puppeteer2.out &
pids+=($!)
